...
if choice1 == "left":
  ...
  if choice2 == "wait":
    ...
    if choice3 == "red":
        print("It's a room with a Fire Monster, Game Over.")
    elif choice3 == "yellow":
        print("You found the treasure You Win!!!")
    elif choice3 == "blue":
        print("You have walked into a room full of monsters, Game Over.") 
    else:
        print("You have given up, Game Over.")
  else:
    print("You get attacked by an angry trouts and it wins, Game Over!! ")
else:
